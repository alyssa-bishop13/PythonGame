...
info.write(
    ...
    "Use 'W' / 'S' for left side player\n"
    "Use 8 / 2 for right side player\n"
...
def start_game():
    info.clear()
    global aim, ball, state, game_running    #clear game
    ball = vector(0, 0)
    aim = vector(value(), value())
    state = {1: 0, 2: 0}
    game_running = True   #start game
